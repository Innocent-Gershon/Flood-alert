    ...
    <div className="bg-[#f4f4ff] min-h-screen flex flex-col">
      ...
      <main className="flex flex-col lg:flex-row items-center justify-between gap-12 px-6 lg:px-24 py-12 flex-1">
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4 items-center justify-center">
          <img src={hero1} alt="Community helping" className="rounded-[100px] shadow-lg" />
          <img src={hero2} alt="Emergency response" className="rounded-[100px] shadow-lg" />
          <img src={hero3} alt="Safe community" className="rounded-[100px] col-span-2 w-full shadow-lg" />
        </div>
      </main>
    </div>
  );
